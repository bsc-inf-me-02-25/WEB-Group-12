...
let ResultsController = class ResultsController {
    ...
    addMark(dto) {
        return this.resultsService.addMark(dto);
    }
    updateMark(id, score) {
        return this.resultsService.updateMark(id, score);
    }
    getStudentResults(id) {
        return this.resultsService.getStudentResults(id);
    }
    getAllResults() {
...
], ResultsController.prototype, "addMark", null);
__decorate([
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:returntype", void 0)
], ResultsController.prototype, "updateMark", null);
__decorate([
